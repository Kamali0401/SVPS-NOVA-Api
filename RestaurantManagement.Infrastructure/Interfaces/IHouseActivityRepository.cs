...
namespace RestaurantManagement.Infrastructure.Interfaces
{
    ...
    /// </summary>
    public interface IHouseActivityRepository
    { /// <summary>
      ...
      /// </returns>
        Task<IEnumerable<HouseActivity>> GetHouseActivity(int? id);
        /// <summary>
        ...
        /// </returns>
        Task<HouseActivity> InsertHouseActivity(HouseActivity inventorys);
        /// <summary>
        ...
        /// Not returns anything.
        /// </returns>
        Task UpdateHouseActivity(HouseActivity inventorys);
        /// <summary>
        ...
        Task<IEnumerable<HousePointModel>> GetHousePointDetails();
    }
}
